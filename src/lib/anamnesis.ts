...
/* ============================================================
   Ficha de Anamnese Inteligente
   Definições de seções/perguntas, alertas críticos e validade.
   ============================================================ */
...
export type Question = {
  ...
  type: QuestionType;
  options?: string[];
  /** Pergunta condicional: só aparece se a chave informada for verdadeira. */
  showIf?: string;
  /** Campo aberto exibido quando a resposta é "sim". */
  detail?: string;
  detailLabel?: string;
  /** Resposta que dispara alerta crítico. */
  alertWhen?: "yes" | "any";
  alertLabel?: string;
  required?: boolean;
};
...
export const BASE_SECTION: Section = {
  ...
  questions: [
    ...
    {
      key: "observacoes",
      label: "Observações adicionais que devemos saber",
      type: "text",
    },
  ],
};
...
/** Descobre a seção de anamnese de um serviço (campo configurado ou por palavra-chave). */
...
/** Extrai alertas críticos das respostas. */

...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      app_role: "super_admin" | "company_admin" | "staff" | "customer" | "receptionist";
      appointment_status:
        | "scheduled"
        | "confirmed"
        | "in_progress"
      ...
      company_status: "active" | "due_soon" | "overdue" | "suspended" | "trial" | "trial_expired";
...
export const Constants = {
  public: {
    Enums: {
      ...
      company_status: ["active", "due_soon", "overdue", "suspended", "trial", "trial_expired"],
      movement_type: ["in", "out", "adjustment"],
      payment_method_kind: ["cash", "pix", "credit_card", "debit_card", "bank_transfer", "other"],
      transaction_type: ["income", "expense"],
    },
  },
} as const;

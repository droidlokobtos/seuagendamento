...
import { mobileAwareAuthStorage } from "./mobileAuthStorage";

// Public project settings. These values are safe to ship to the browser and
// keep the published Lovable app available when build-time env injection is
...
function createSupabaseClient() {
  ...
  return createClient<Database>(SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY, {
    ...
    auth: {
      storage: mobileAwareAuthStorage(),
      persistSession: true,

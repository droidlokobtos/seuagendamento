...
// Public browser credentials. The anon key is intentionally public and all
// authorization remains enforced by Supabase RLS. These values keep the app
// available when the hosting provider does not expose build-time VITE_* vars.
